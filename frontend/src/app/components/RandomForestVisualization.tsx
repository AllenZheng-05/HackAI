...
export function RandomForestVisualization({
  ...
  useEffect(() => {
    ...
    for (let t = 0; t < displayTrees; t++) {
      ...
      const verticalSpacing = (height - 80) / (visibleDepth + 1);
      ...
      buildTree(treeOffsetX, 40, 0, initialSpread);
    ...
    const animate = () => {
      ...
      for (let t = 0; t < displayTrees; t++) {
        ...
        ctx.fillText(`Tree ${t + 1}`, x, height - 10);
      }
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 relative rounded-xl overflow-hidden bg-gradient-to-br from-[#0A0A0F] to-[#14141F] border border-white/10">
        ...
        {/* Legend */}
        <div className="absolute bottom-3 left-3 flex gap-4 text-xs text-gray-400">
